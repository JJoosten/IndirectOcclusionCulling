    ...
    UINT AffinityMask)
{
    ...
    {
        ReleaseLog("D3DX12AffinityLayer: Committed resource is not write combine, creating no shadow buffer.\n", Resource->mBufferSize);
...
{
    DebugLog("Writing application message: %s\n", Message);
    if (InfoQueue)
    {
    ...
    {
        DebugLog("No InfoQueue to write application message.\n");
    }
}

...
class D3DX12AF_API __declspec(uuid("BE1D71C8-88FD-4623-ABFA-D0E546D12FAF")) CD3DX12AffinityDevice : public CD3DX12AffinityObject
{
    friend class CD3DX12AffinityResource;
	friend class CD3DX12AffinityCommandQueue;
...
public:
    ...
    HRESULT STDMETHODCALLTYPE CreateCommandSignature(
        ...
        _In_ REFIID riid,
        _Outptr_opt_  void** ppvCommandSignature,
        _In_opt_  UINT AffinityMask = EAffinityMask::AllNodes);

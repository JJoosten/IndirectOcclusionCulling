...
void CD3DX12AffinityResource::SynchronizeAcrossDevices()
{
    ...
    case D3D12_CPU_PAGE_PROPERTY_WRITE_BACK:
        ...
        ReleaseLog("D3DX12AffinityLayer: [memcpy] Synchronized %lu bytes of WRITE_BACK memory.\n", mBufferSize);
        break;
    case D3D12_CPU_PAGE_PROPERTY_WRITE_COMBINE:
    {
...
#else
        static __declspec(thread) void** WrittenAddresses = nullptr;
        ...
        ReleaseLog("D3DX12AffinityLayer: [memcpy] Synchronized %lu bytes of shadow buffered memory.\n", BytesCopied);
        break;
    }
    case D3D12_CPU_PAGE_PROPERTY_NOT_AVAILABLE:
    ...
    case D3D12_CPU_PAGE_PROPERTY_UNKNOWN:
        ...
        break;
    default:
        DebugLog("Unexpected CPU page value: %d\n", mCPUPageProperty);

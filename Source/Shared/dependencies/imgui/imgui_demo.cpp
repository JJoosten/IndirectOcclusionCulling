...
// You can call ImGui::ShowTestWindow() in your code to learn about various gpu_features of ImGui.
...
void ImGui::ShowUserGuide()
{
    ...
    ImGui::BulletText("CTRL+Click on a slider or drag gpu_box to input text.");
    ImGui::BulletText(
        "While editing text:\n"
...
// Demonstrate most ImGui gpu_features (big function!)
void ImGui::ShowTestWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        if (ImGui::TreeNode("Clipping"))
        {
            ...
            ImGui::TextWrapped("On a per-widget basis we are occasionally clipping text CPU-side if it won't fit in its frame. Otherwise we are doing coarser clipping + passing a scissor gpu_rectangle to the renderer. The system is designed to try minimizing both execution and CPU/GPU rendering cost.");
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // Demonstrate keeping auto focus on the input gpu_box
